(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AllOrderListComponent = /** @class */ (function () {
                // status:String
                ...
                AllOrderListComponent.prototype.ondelete = function (id) {
                    console.log(id);
                ...
                AllOrderListComponent.prototype.loadAllProducts = function () {
                    var _this = this;
                    this.date = new Date();
                ...
                AllOrderListComponent.prototype.isexpire = function (product) {
                    var currentdate = new Date();
                    return new Date(product.deliveryDate).valueOf() < new Date(currentdate).valueOf();
                };
                return AllOrderListComponent;
            }());
            AllOrderListComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AllOrderListService = /** @class */ (function () {
                ...
                AllOrderListService.prototype.getAllProducts = function () {
                    return this.http.get(this.url);
                };
                AllOrderListService.prototype.deleteProduct = function (id) {
                    this.url1 = this.url1 + '/' + id;
                    return this.http.delete(this.url1);
                };
                return AllOrderListService;
            }());
            AllOrderListService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CartService = /** @class */ (function () {
                ...
                CartService.prototype.getPostUpdateListener = function () {
                    // this returns postsUpdated as Observable()
                    return this.postsUpdated.asObservable();
                };
                CartService.prototype.addUsers = function (day, title, count) {
                    var _this = this;
                    var sched = {
                        id: null,
                        day: day,
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CartComponent = /** @class */ (function () {
                function CartComponent(service, activateRoute, cservice, route, http) {
                    this.service = service;
                ...
                /*addMe()
            {
                ...
                CartComponent.prototype.mondayIt = function () {
                    this.monday = true;
                };
                CartComponent.prototype.TuesdayIt = function () {
                    this.tue = true;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var CartProductDetailsService = /** @class */ (function () {
                ...
                CartProductDetailsService.prototype.getProduct = function (id) {
                    return this.httpClient.get(this.url + id);
                };
                CartProductDetailsService.prototype.postInCart = function (Quantity, totalAmount, totalDiscount, MRid, productID, orderDetailsTableID) {
                    var body = {
                        Quantity: Quantity,
                ...
                CartProductDetailsService.prototype.DeleteFromCart = function (id) {
                    var body = {
                        id: id
                    };
            ...
            CartProductDetailsService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CartProductDetailsComponent = /** @class */ (function () {
                    ...
                    if (this.id) {
                        this.service.getProduct(this.id).subscribe(function (response) {
                            if (response['status'] == 'success') {
                                ...
                                _this.rate = _this.product.priceWithDiscount;
                                _this.temp = _this.rate;
                            }
                        });
                    }
                    this.count = Number(localStorage['Quantity']);
                }
                CartProductDetailsComponent.prototype.OnIncrement = function () {
                    this.count = this.count + 1;
                    this.rate = this.temp * this.count;
                };
                CartProductDetailsComponent.prototype.OnDecrement = function () {
                    if (this.count == 0) {
                ...
                CartProductDetailsComponent.prototype.onAddToCart = function () {
                    var _this = this;
                    if (localStorage['login_status'] == '0') {
                        ...
                        if (this.count != 0) {
                            this.cartService.postInCart(this.count, this.rate, this.totalDiscount, this.MRid, this.id, this.orderDetailsTableID)
                                ...
                                if (response['status'] == 'success') {
                                    alert('item updated');
                                    _this.route.navigate(['MRlogin/cart']);
                                }
                            });
                        }
                        else {
                ...
                CartProductDetailsComponent.prototype.OnOrderNow = function () {
                };
                CartProductDetailsComponent.prototype.ngOnInit = function () { };
                return CartProductDetailsComponent;
            }());
            CartProductDetailsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MRRegisterComponent = /** @class */ (function () {
                ...
                MRRegisterComponent.prototype.ngOnInit = function () { };
                MRRegisterComponent.prototype.onadd = function () {
            ...
            MRRegisterComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MRRegisterService = /** @class */ (function () {
                function MRRegisterService(http) {
                    this.http = http;
                    // http: HttpClient
                ...
                MRRegisterService.prototype.getPosts = function () {
                    var _this = this;
                ...
                MRRegisterService.prototype.getPostUpdateListener = function () {
                    // this returns postsUpdated as Observable()
                    return this.postsUpdated.asObservable();
                };
                MRRegisterService.prototype.addUsers = function (username, firstname, lastname, joindate, phoneno, password, email) {
                    var _this = this;
                    var post = {
                        id: null,
                        username: username,
            ...
            MRRegisterService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var MRloginComponent = /** @class */ (function () {
                // isLoggedIn = false
                function MRloginComponent(router, service, http) {
                    this.router = router;
                    this.service = service;
                    this.http = http;
                    this.email = '';
                ...
                MRloginComponent.prototype.onlogin = function () {
                    var _this = this;
                    if (this.email.length == 0) {
                        ...
                        var lg = { email: this.email, password: this.password };
                        this.http
                            .post("http://localhost:3000/api/posts", lg)
                            .subscribe(function (responseData) {
                            if (responseData.message == 1) {
                                alert("succes");
                                _this.router.navigate(['/MRlogin/home']);
            ...
            MRloginComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            MRloginService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MROrderListComponent = /** @class */ (function () {
                // status:String
                ...
                MROrderListComponent.prototype.ondelete = function (id) {
                    console.log(id);
                    if (confirm('Are you sure to delete an item')) {
                        this.service
                            .deleteProduct(id)
                ...
                MROrderListComponent.prototype.loadAllProducts = function () {
                    var _this = this;
                    this.date = new Date();
                    this.service
                ...
                MROrderListComponent.prototype.isexpire = function (product) {
                    var currentdate = new Date();
                    return new Date(product.deliveryDate).valueOf() < new Date(currentdate).valueOf();
                };
                return MROrderListComponent;
            }());
            MROrderListComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var MRordersListService = /** @class */ (function () {
                function MRordersListService(httpClient) {
                    this.url = 'http://localhost:4000/MRlogin/dashboard/MRorders'; //express port 4000
                    this.url1 = 'http://localhost:4000/MRlogin/orders';
                    this.http = httpClient;
                }
                MRordersListService.prototype.getAllProducts = function (id) {
                    this.url = this.url + '/' + id;
                    console.log(this.url);
                    return this.http.get(this.url);
                };
                MRordersListService.prototype.deleteProduct = function (id) {
                    this.url1 = this.url1 + '/' + id;
                    return this.http.delete(this.url1);
                };
                return MRordersListService;
            }());
            MRordersListService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var SearchProductService = /** @class */ (function () {
                function SearchProductService(httpClient) {
                    this.httpClient = httpClient;
                    this.url = 'http://localhost:4000/MRlogin/search';
                }
                SearchProductService.prototype.getSearch = function (ProductName) {
                    var body = {
            ...
            SearchProductService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchProductComponent = /** @class */ (function () {
                ...
                SearchProductComponent.prototype.loadAllProducts = function () {
                    var _this = this;
                    ...
                    this.service
                        ...
                        .subscribe(function (response) {
                        if (response['status'] == 'success') {
                            _this.SearchArray = response['data'];
                            if (_this.SearchArray.length == 0) {
                                _this.msg = 'we did not find your matching result';
                            }
                            else {
                                _this.msg = 'we found these results';
                            }
                        }
                        else {
                            alert('error');
                ...
                SearchProductComponent.prototype.loadflag = function () {
                ...
                SearchProductComponent.prototype.OnSelectProduct = function (id) {
                    this.router.navigate(['/MRlogin/product_details/' + id]);
                };
                return SearchProductComponent;
            }());
            SearchProductComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserOrderListComponent = /** @class */ (function () {
                ...
                UserOrderListComponent.prototype.ondelete = function (id) {
                    console.log(id);
                    if (confirm('Are you sure to delete an item')) {
                        this.service
                            .deleteProduct(id)
                ...
                UserOrderListComponent.prototype.loadAllProducts = function () {
                    var _this = this;
                    this.date = new Date();
                    this.mrid = localStorage['id'];
                    this.service
                ...
                UserOrderListComponent.prototype.isexpire = function (product) {
                    var currentdate = new Date();
            ...
            UserOrderListComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var UserOrderListService = /** @class */ (function () {
                function UserOrderListService(httpClient) {
                    this.url = 'http://localhost:4000/MRlogin/orders'; //express port 4000
                    this.http = httpClient;
                }
                UserOrderListService.prototype.getAllProducts = function (mrid) {
                    var body = {
                        mrid: mrid
                    };
                    return this.http.post(this.url, body);
                };
                UserOrderListService.prototype.deleteProduct = function (id) {
                    this.url = this.url + '/' + id;
                    return this.http.delete(this.url);
                };
                return UserOrderListService;
            }());
            UserOrderListService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserOrdersService = /** @class */ (function () {
                ...
                UserOrdersService.prototype.UpdateOrders = function (OrderDate, deliveryDate, PaymentMode, mrid, drname, addressOFdr, drphoneno) {
                    var body = {
                        OrderDate: OrderDate,
                ...
                UserOrdersService.prototype.InsertLocation = function (fullname, phoneno, state, city, pincode, address, mrid) {
                    var body = {
                        fullname: fullname,
                        phoneno: phoneno,
                        state: state,
            ...
            UserOrdersService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserOrdersComponent = /** @class */ (function () {
                ...
                UserOrdersComponent.prototype.onadd = function () {
                    var _this = this;
                    ...
                    if (this.fullname.length == 0) {
                        ...
                        if (confirm('Are you sure ? Once Ordered can not be canceled')) {
                            ...
                            this.service.UpdateOrders(this.OrderDate, this.deliveryDate, this.PaymentMode, mrid, drname, addressOFdr, drphoneno)
                                ...
                                if (response['status'] == 'success') {
                                    alert('success');
                                    _this.router.navigate(['/MRlogin/cart']);
                                }
                                else {
                                    console.log(response['error']);
                                    alert('error');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Add_drComponent = /** @class */ (function () {
                function Add_drComponent(router, userservice) {
                    this.router = router;
                    this.service = userservice;
                }
                Add_drComponent.prototype.back = function () {
                    this.router.navigate(['/login/dashboard/drs']);
                };
                Add_drComponent.prototype.onadd = function () {
                ...
                Add_drComponent.prototype.ngOnInit = function () { };
                return Add_drComponent;
            }());
            Add_drComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var AddDRService = /** @class */ (function () {
                function AddDRService(httpClient) {
                    this.url = 'http://localhost:4000/login/dashboard/dr'; //express port 4000
                    this.http = httpClient;
                }
                AddDRService.prototype.addDR = function (firstname, lastname, phoneNo, degree) {
                    var body = {
                        firstname: firstname,
                        lastname: lastname,
                        phoneNo: phoneNo,
                ...
                AddDRService.prototype.deleteProduct = function (id) {
                    return this.http.delete(this.url + '/' + id);
                };
                AddDRService.prototype.getAllProducts = function () {
                    return this.http.get(this.url);
                };
                return AddDRService;
            }());
            AddDRService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Add_productComponent = /** @class */ (function () {
                ...
                Add_productComponent.prototype.back = function () {
                    this.router.navigate(['/login/dashboard/product']);
                };
                Add_productComponent.prototype.addProduct = function () {
                ...
                Add_productComponent.prototype.ngOnInit = function () {
                    this.loadCategories();
                };
                Add_productComponent.prototype.loadCategories = function () {
                    var _this = this;
                    this.catservice.getCategories().subscribe(function (response) {
                        if (response['status'] == 'success') {
                            _this.cat = response['data'];
                            if (_this.cat.length > 0)
                                _this.categoryid = _this.cat[0].id;
                        }
                    });
                };
                Add_productComponent.prototype.onSelectImage = function (event) {
                    this.image = event.target.files[0];
                };
                return Add_productComponent;
            }());
            Add_productComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddProductService = /** @class */ (function () {
                ...
                AddProductService.prototype.addService = function (name, price, discount, priceWithDiscount, doseInMG, mgfdate, expiredate, description, image, categoryid) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Add_userComponent = /** @class */ (function () {
                function Add_userComponent(router, userservice) {
                    this.router = router;
                    this.service = userservice;
                }
                Add_userComponent.prototype.back = function () {
                    this.router.navigate(['/login/dashboard/user']);
                };
                Add_userComponent.prototype.onadd = function () {
                ...
                Add_userComponent.prototype.ngOnInit = function () { };
                return Add_userComponent;
            }());
            Add_userComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddUserService = /** @class */ (function () {
                ...
                AddUserService.prototype.addUsers = function (username, firstname, lastname, joindate, phoneno, email, password) {
                    var body = {
                        username: username,
                        firstname: firstname,
                        lastname: lastname,
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
            var AllopathicService = /** @class */ (function () {
                function AllopathicService(http) {
                    this.http = http;
                    this.prods = [];
                    this.postsUpdated = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
            ...
            AllopathicService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var _services_Combine_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../services/Combine.service */ "./src/app/services/Combine.service.ts");
            var AllopathicComponent = /** @class */ (function () {
                function AllopathicComponent(router, service, http, cservice) {
                    this.router = router;
                    this.service = service;
                    this.http = http;
                    this.cservice = cservice;
                ...
                AllopathicComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.http
                ...
                AllopathicComponent.prototype.showDetails = function (id) {
                    // this.router.navigate(['/MRlogin/product_details/'+id]);
                    this.type = 'upper';
            ...
            AllopathicComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                ...
                AppComponent.prototype.loadStatus = function () {
                    if (this.status == '1') {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var AyurvedicService = /** @class */ (function () {
                function AyurvedicService(httpClient) {
                    this.httpClient = httpClient;
                    this.url = 'http://localhost:4000/MRlogin/ayurvedic';
                }
                AyurvedicService.prototype.getAyurvedic = function () {
                    return this.httpClient.get(this.url);
                };
                return AyurvedicService;
            }());
            AyurvedicService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AyurvedicComponent = /** @class */ (function () {
                ...
                AyurvedicComponent.prototype.loadAllProducts = function () {
                    var _this = this;
                    this.service
                        .getAyurvedic()
                        .subscribe(function (response) {
                        if (response['status'] == 'success') {
                            _this.Ayurvedic = response['data'];
                        }
                        else {
                            alert('error');
                        }
                ...
                AyurvedicComponent.prototype.loadflag = function () {
                    if (localStorage['flag'] == '0') {
                        window.location.reload();
                        localStorage['flag'] = '1';
                    }
                };
                AyurvedicComponent.prototype.ngOnInit = function () {
                };
                AyurvedicComponent.prototype.OnSelectProduct = function (id) {
                    this.router.navigate(['/MRlogin/product_details/' + id]);
                };
                return AyurvedicComponent;
            }());
            AyurvedicComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ChooseComponent = /** @class */ (function () {
                function ChooseComponent(router, cservice) {
                    this.router = router;
                    this.cservice = cservice;
                    this.dateIs = " ";
                    this.prods = [];
                ...
                ChooseComponent.prototype.upperBody = function () {
                ...
                ChooseComponent.prototype.yoga = function () {
                    if (this.dateIs === undefined) {
                        alert("select a date");
                    }
                    else {
                ...
                ChooseComponent.prototype.lowerBody = function () {
                    this.router.navigate(['/MRlogin/lower']);
                    //console.log(moment(this.dateIs).format('dddd (Do MMMM YYYY)'));
                    this.cservice.addDate(this.dateIs);
                };
                ChooseComponent.prototype.finalise = function () {
                };
                ChooseComponent.prototype.DateAdd = function () {
                    this.cservice.addDate(this.dateIs);
                    console.log(this.dateIs);
                };
                return ChooseComponent;
            }());
            ChooseComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DoctorComponent = /** @class */ (function () {
                ...
                DoctorComponent.prototype.loadAllProducts = function () {
                    var _this = this;
                    this.service
                        .getAllProducts()
                        .subscribe(function (response) {
                ...
                DoctorComponent.prototype.ondelete = function (productId) {
                    var _this = this;
                    this.service
                ...
                DoctorComponent.prototype.onAddDR = function () {
                    this.router.navigate(['/login/dashboard/drs/add_dr']);
                };
                DoctorComponent.prototype.dashboard = function () {
                    this.router.navigate(['/login/dashboard']);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DrService = /** @class */ (function () {
                ...
                DrService.prototype.getdr = function () {
                    return this.http.get(this.url);
                };
                DrService.prototype.getAllProducts = function () {
                    return this.http.get(this.url);
                };
                DrService.prototype.deleteProduct = function (id) {
                    return this.http.delete(this.url + '/' + id);
                };
                return DrService;
            }());
            DrService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var Edit_productComponent = /** @class */ (function () {
                    ...
                    if (this.id) {
                        this.service.getUserDetails(this.id).subscribe(function (response) {
                            if (response['status'] == 'success') {
                                ...
                                _this.name = user[0].name;
                                _this.price = user[0].price;
                                _this.discount = user[0].discount;
                                _this.priceWithDiscount = user[0].priceWithDiscount;
                                _this.doseInMG = user[0].doseInMG;
                                _this.mgfdate = user[0].mgfdate;
                                _this.expiredate = user[0].expiredate;
                                _this.description = user[0].description;
                            }
                            else {
                                console.log(response['error']);
                            }
                ...
                Edit_productComponent.prototype.ngOnInit = function () {
                    this.loadCategories();
                };
                Edit_productComponent.prototype.loadCategories = function () {
                    var _this = this;
                    this.catservice.getCategories().subscribe(function (response) {
                        if (response['status'] == 'success') {
                            _this.cat = response['data'];
                ...
                Edit_productComponent.prototype.onUpdate = function () {
                    var _this = this;
                    this.service
                        ...
                        if (response['status'] == 'success') {
                            ...
                            _this.router.navigate(['/login/dashboard/product']);
                        }
                        else {
                            console.log(response['error']);
                            alert("error");
            ...
            Edit_productComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var EditProductService = /** @class */ (function () {
                ...
                EditProductService.prototype.edit_Product = function (name, price, discount, priceWithDiscount, doseInMG, mgfdate, expiredate, description, categoryid, id) {
                    var body = {
                        name: name,
                        price: price,
                        discount: discount,
                ...
                EditProductService.prototype.getUserDetails = function (id) {
                    return this.http.get(this.url + '/' + id);
                };
                EditProductService.prototype.getCategories = function () {
                    return this.http1.get(this.url1);
                };
                return EditProductService;
            }());
            EditProductService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var Edit_userComponent = /** @class */ (function () {
                function Edit_userComponent(movieService, service, router, activatedRoute) {
                    ...
                    if (this.id) {
                        this.service.getUserDetails(this.id).subscribe(function (response) {
                            if (response['status'] == 'success') {
                                var user = response['data'];
                                _this.username = user[0].username;
                                _this.firstname = user[0].firstname;
                                _this.lastname = user[0].lastname;
                                _this.joindate = user[0].joindate;
                                _this.phoneno = user[0].phoneno;
                                _this.email = user[0].email;
                                _this.password = user[0].password;
                            }
                            else {
                                console.log(response['error']);
                            }
                ...
                Edit_userComponent.prototype.ngOnInit = function () { };
                Edit_userComponent.prototype.onUpdate = function () {
                    var _this = this;
                    this.movieService
                        ...
                        if (response['status'] == 'success') {
                            alert('user-updated');
                            _this.router.navigate(['/login/dashboard/user']);
                        }
                        else {
                            console.log(response['error']);
                            alert("error");
            ...
            Edit_userComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditUserService = /** @class */ (function () {
                ...
                EditUserService.prototype.edit_movie = function (username, firstname, lastname, joindate, phoneno, email, password, id, exist) {
                    var body = {
                        username: username,
                        firstname: firstname,
                        lastname: lastname,
                ...
                EditUserService.prototype.getUserDetails = function (id) {
                    return this.http.get(this.url + '/' + id);
                };
                return EditUserService;
            }());
            EditUserService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            */
            var FinalService = /** @class */ (function () {
                function FinalService(http, cservice) {
                    this.http = http;
                    this.cservice = cservice;
                    this.prods = [];
                    this.postsUpdated = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
            ...
            FinalService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            */
            var FinaliseComponent = /** @class */ (function () {
                function FinaliseComponent(router, service, http, cservice) {
                    this.router = router;
                    this.service = service;
                    this.http = http;
                    this.cservice = cservice;
                ...
                FinaliseComponent.prototype.ngOnInit = function () {
                    var _this = this;
            ...
            FinaliseComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            var HomoeopathyService = /** @class */ (function () {
                function HomoeopathyService(httpClient) {
                    this.httpClient = httpClient;
                    this.url = 'http://localhost:4000/MRlogin/homoeopathy';
                }
                HomoeopathyService.prototype.getHomoeopathy = function () {
                    return this.httpClient.get(this.url);
                };
                return HomoeopathyService;
            }());
            HomoeopathyService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomoeopathyComponent = /** @class */ (function () {
                ...
                HomoeopathyComponent.prototype.loadAllProducts = function () {
                    var _this = this;
                    this.service
                        .getHomoeopathy()
                        .subscribe(function (response) {
                        if (response['status'] == 'success') {
                            _this.Homoeopathy = response['data'];
                        }
                        else {
                            alert('error');
                        }
                ...
                HomoeopathyComponent.prototype.loadflag = function () {
                    if (localStorage['flag'] == '0') {
                        window.location.reload();
                        localStorage['flag'] = '1';
                    }
                };
                HomoeopathyComponent.prototype.ngOnInit = function () {
                };
                HomoeopathyComponent.prototype.OnSelectProduct = function (id) {
                    this.router.navigate(['/MRlogin/product_details/' + id]);
                };
                return HomoeopathyComponent;
            }());
            HomoeopathyComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.loadAllProducts = function () {
                    var _this = this;
                    this.service
                        .getAllProducts()
                        .subscribe(function (response) {
                ...
                LoginComponent.prototype.onUserSelect = function (id) {
                    this.router.navigate(['/login/dashboard/user/edit_user/' + id]);
                };
                LoginComponent.prototype.ondelete = function (productId) {
                    var _this = this;
                    this.service
                        .deleteProduct(productId)
                        .subscribe(function (response) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.getAllProducts = function () {
                    return this.http.get(this.url);
                };
                UserService.prototype.getUsers = function () {
                    return this.http.get(this.url);
                };
                UserService.prototype.deleteProduct = function (id) {
                    return this.http.delete(this.url + '/' + id);
                };
                return UserService;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var _services_Combine_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../services/Combine.service */ "./src/app/services/Combine.service.ts");
            var LowerComponent = /** @class */ (function () {
                function LowerComponent(router, service, http, cservice) {
                    this.router = router;
                    this.service = service;
                    this.http = http;
                    this.cservice = cservice;
                ...
                LowerComponent.prototype.showDetails = function (id) {
                    // this.router.navigate(['/MRlogin/product_details/'+id]);
                    this.type = 'lower';
                    this.cservice.typeIs(this.type);
                    this.ID = id;
            ...
            LowerComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
            var LowerserviceService = /** @class */ (function () {
                function LowerserviceService(http) {
                    this.http = http;
                    this.prods = [];
                    this.postsUpdated = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
                    this.url = 'http://localhost:4000/MRlogin/products';
                }
                LowerserviceService.prototype.getPosts = function () {
                    var _this = this;
                    this.http
                        .get("http://localhost:3000/api/lowers")
                        .subscribe(function (responseData) {
                ...
                LowerserviceService.prototype.getPostUpdateListener = function () {
                    return this.postsUpdated.asObservable();
                };
                return LowerserviceService;
            }());
            LowerserviceService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductDetailsService = /** @class */ (function () {
                function ProductDetailsService(http, cservice) {
                    this.http = http;
                    this.cservice = cservice;
                    this.url = 'http://localhost:4000/login/dashboard/product/';
                ...
                ProductDetailsService.prototype.postInCart = function (Quantity, totalAmount, totalDiscount, MRid, productID) {
                    var body = {
                        Quantity: Quantity,
                        totalAmount: totalAmount,
                        totalDiscount: totalDiscount,
                ...
                ProductDetailsService.prototype.addUsers = function (day, title, count) {
                    var _this = this;
                    var sched = {
                        id: null,
                        day: day,
                ...
                ProductDetailsService.prototype.getPostUpdateListener = function () {
                    // this returns postsUpdated as Observable()
                    return this.postsUpdated.asObservable();
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductDetailsComponent = /** @class */ (function () {
                function ProductDetailsComponent(service, activateRoute, cartService, cservice, route, http) {
                ...
                ProductDetailsComponent.prototype.OnIncrement = function () {
                    this.count = this.count + 1;
                    this.rate = this.temp * this.count;
                    this.cservice.showCount(this.count);
                };
                ProductDetailsComponent.prototype.OnDecrement = function () {
                    if (this.count == 1) {
                        alert('Can not decrement');
                    }
                    else {
                ...
                ProductDetailsComponent.prototype.onAddToCart = function (id) {
                    /*  if(localStorage['login_status'] == '0'){
                         alert('You need to login first')
                         this.route.navigate(['/MRlogin'])
                      }
                ...
                ProductDetailsComponent.prototype.OnOrderNow = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductComponent = /** @class */ (function () {
                ...
                ProductComponent.prototype.dashboard = function () {
                    this.router.navigate(['/login/dashboard']);
                };
                ProductComponent.prototype.loadAllProducts = function () {
                    var _this = this;
                    this.service
                        .getAllProducts()
                        .subscribe(function (response) {
                ...
                ProductComponent.prototype.ondelete = function (productId) {
                    var _this = this;
                    this.service
                        .deleteProduct(productId)
                        .subscribe(function (response) {
                ...
                ProductComponent.prototype.onSelect = function (id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CombineService = /** @class */ (function () {
                function CombineService(http) {
                    this.http = http;
                    this.prods = [];
                    this.postsUpdated = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
                }
                CombineService.prototype.addIt = function (value) {
                    this.ID = value;
                };
                CombineService.prototype.show = function () {
                    return this.ID;
                };
                CombineService.prototype.showCount = function (cnt) {
                    this.count = cnt;
                };
                CombineService.prototype.addDate = function (date) {
                    this.Date = date;
                };
                CombineService.prototype.showDetails = function () {
                    return this.count;
                };
                CombineService.prototype.typeIs = function (type) {
                    this.Type = type;
                };
                return CombineService;
            }());
            CombineService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GetProductService = /** @class */ (function () {
                ...
                GetProductService.prototype.getAllProducts = function () {
                    return this.httpClient.get(this.url);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserHomeComponent = /** @class */ (function () {
                function UserHomeComponent(router, productservice, cservice, service) {
                    this.router = router;
                    this.productservice = productservice;
                    this.cservice = cservice;
                    this.service = service;
              ...
              OnSelectProduct(id: number) {
                ...
                UserHomeComponent.prototype.DateAdd = function () {
                    this.cservice.addDate(this.dateIs);
                    console.log(this.dateIs);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var _services_Combine_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../services/Combine.service */ "./src/app/services/Combine.service.ts");
            var YogaComponent = /** @class */ (function () {
                function YogaComponent(router, service, http, cservice) {
                    this.router = router;
                    this.service = service;
                    this.http = http;
                    this.cservice = cservice;
                ...
                YogaComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.http
                ...
                YogaComponent.prototype.showDetails = function (id) {
                    this.type = 'yoga';
                    this.cservice.typeIs(this.type);
                    this.ID = id;
                    console.log(this.ID);
                ...
                return YogaComponent;
            }());
            YogaComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
            var YogaService = /** @class */ (function () {
                function YogaService(http) {
                    this.http = http;
                    this.prods = [];
                    this.postsUpdated = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
                }
                YogaService.prototype.getPosts = function () {
                    var _this = this;
                    this.http
                        .get("http://localhost:3000/api/yogas")
                        .subscribe(function (responseData) {
                ...
                YogaService.prototype.getPostUpdateListener = function () {
                    return this.postsUpdated.asObservable();
                };
                return YogaService;
            }());
            YogaService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
